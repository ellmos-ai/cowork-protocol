...
The public site is a deliberately small allowlisted artifact. It contains the FormBuilder showcase, its three runtime protocol packages, the license and a root redirect. It excludes tests, repository documentation, Devpost drafts and internal planning paths.
