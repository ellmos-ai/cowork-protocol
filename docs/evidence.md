...
| Public-preview tree is reproducible | clean clone of local `release/public-preview` at `0bac68c` | `npm ci`, 91/91 tests, 11/11 character evals, 7/7 proof steps, native Chrome 152 WebMCP smoke, 16-file Pages build, 44 syntax checks, 0 vulnerabilities, 0 secret findings and clean scoped history |
