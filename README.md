...
The current UI keeps all 41 controls reachable at true 200% browser zoom and
at a 390×844 CSS viewport: 41/41 AX controls are named, 41/41 Tab stops are
visible, and horizontal overflow is zero. The rendered-contrast smoke audits
1,446 visible text items across eleven states (the FormBuilder Studio
