...
at a 390×844 CSS viewport: all 36 interactive controls carry a named accessibility node and a visible Tab stop, and horizontal
overflow is zero. The rendered-contrast smoke audits
1343 visible text items across eleven states (the FormBuilder Studio field
